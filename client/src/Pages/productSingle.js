        ...
        <Containers>
          <Row>
            ...
            <ProductContentCol>
              ...
              <ProductQuantity>
                <TpQuantity>
                  <TpCartMinus onClick={() => handleDecrease}>
                  ...
                  <TpCartInput readOnly type="text" value={quantity} />
                  <TpCartPlus onClick={() => handleIncrease}>
                        ...
                        <ProductItem>
                          ...
                          <ProductContent>
                            <ProductTitle className="relatedTitle">
                              <Link to={`/product/${relatedProduct._id}`}>{relatedProduct.title}</Link>
                            </ProductTitle>
                            <ProductPricing>
